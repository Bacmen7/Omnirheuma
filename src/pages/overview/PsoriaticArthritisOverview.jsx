...
const quickAnswers = [
  "Psoriatic arthritis is an autoimmune condition where the body attacks itself. It affects joints and skin.",
  "About 1 in 3 people with psoriasis develop psoriatic arthritis.",
  "Stress, infections, joint injury, and certain medications are common triggers.",
  "Common symptoms include joint pain, morning stiffness, swollen “sausage” fingers/toes, and nail changes like pitting or thickening.",
...
const geneticFactors = [
  { title: "Genetic marker HLA-B27", desc: "The HLA-B27 gene is linked to spine involvement in some patients. Not everyone with this gene develops PsA, but it increases the chances." },
  { title: "Family history", desc: "Having a close family member with psoriasis or psoriatic arthritis makes an individual vulnerable. If these conditions run in the family, joint symptoms should be checked by a doctor early." },
]
...
const triggers = [
  ...
  { title: "Infections", desc: "Throat infections caused by bacteria and other infections can worsen the condition." },
  { title: "High stress", desc: "Increased stress is one of the most common triggers of psoriatic arthritis." },
  { title: "Certain medications", desc: "Lithium, chloroquine (malaria medicine), and beta-blockers (heart medicines) are associated with worsening of psoriasis and can trigger joint symptoms." },
]

const jointSymptoms = [
  { title: "Pain and swelling", desc: "Joints feel painful, warm, and visibly swollen. Symptoms worsen after sitting still for a short duration." },
  { title: "Morning stiffness", desc: "Difficulty moving joints after waking up. The stiffness gradually reduces within 30 to 60 minutes." },
  { title: "Flares and remissions", desc: "Symptoms intensify suddenly and then settle down. This pattern makes the condition easy to ignore." },
  { title: "Reduced range of motion", desc: "When left untreated, swelling and irritation increase, reducing how far a joint can bend or stretch." },
]

const riskFactors = [
  "Patients with psoriasis",
  "Family members or close relatives with psoriasis or psoriatic arthritis",
  "Age between 30 and 55 years",
]

const livingTips = [
  "An anti-inflammatory diet with turmeric, mustard oil, flaxseeds, and fish",
  "Reduce refined sugar and processed foods",
  "Stay in a healthy weight range to reduce joint load",
  "Low-impact exercise like walking, swimming, and yoga",
  "Physiotherapist-suggested positions for floor-sitting to protect knees and hips",
  "Visit your rheumatologist early instead of self-medicating",
]

const faqs = [
  { q: "Can psoriatic arthritis be cured?", a: "There is no cure. But treatment can control inflammation and protect the joints, allowing most people to live an active life. The main goal of treatment is to lower disease progression and flare-ups." },
...
const tabs = ["Overview", "Symptoms", "Diagnosis", "Treatment", "Living With PsA"]
const tabTargets = { Overview: "what-is-psa", Symptoms: "symptoms", Diagnosis: "diagnosis", Treatment: "treatment", "Living With PsA": "living" }
            ...
            <div style={{ position: "relative", paddingBottom: "52px" }}>
              <div style={{ background: "linear-gradient(135deg, #0f616e 0%, #1AA3B5 100%)", borderRadius: "6px", padding: "40px 32px 76px", position: "relative", overflow: "hidden" }}>
                <div style={{ width: "clamp(200px, 40vw, 300px)", height: "clamp(200px, 40vw, 300px)", borderRadius: "50%", margin: "0 auto", overflow: "hidden", border: "5px solid rgba(255,255,255,0.35)", backgroundColor: "rgba(255,255,255,0.95)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <img src="/condition/Psoriatic Arthritis.webp" alt="Psoriatic Arthritis" style={{ width: "82%", height: "82%", objectFit: "contain", display: "block" }} />
                </div>
              </div>

              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4" style={{ position: "relative", marginTop: "-44px", padding: "0 clamp(0px, 4vw, 24px)" }}>
                {tabs.map((t) => (
                  <button key={t} onClick={() => scrollTo(tabTargets[t])} className="nav-tab transition-all hover:-translate-y-1" style={{ backgroundColor: "#ffffff", border: "1px solid #e6ecf1", borderRadius: "6px", color: "#0f616e", padding: "22px 14px", fontSize: "14px", fontWeight: 700, cursor: "pointer", boxShadow: "0 6px 24px rgba(15,97,110,0.12)", fontFamily: "var(--font-base)" }}>
                    {t}
                  </button>
                ))}
              </div>
          ...
          <div className="max-w-[820px] mx-auto px-5 sm:px-6 pt-14 pb-14" style={{ "--color-navy-deep": "#1a1a1a", "--color-navy-muted": "#1a1a1a" }}>
            ...
            <div id="overview" style={{ scrollMarginTop: "80px" }}>
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.5rem" }}>
                Noticed skin itching lately? The small patch of itchy skin that turns scaly on your fingers is easy to ignore as dry skin. A skin specialist confirms it as psoriasis, and for a while that feels fine — with medications and follow-ups.
              </p>
              ...
              <p className="text-[16px] leading-[1.8] text-navy-muted">
                Doctors confirm the diagnosis, and the right treatment can manage symptoms and protect the joints from further damage. This article helps you understand what psoriatic arthritis is, its symptoms, causes, and what treatment looks like in India.
              </p>
            </div>
            ...
            <div id="what-is-psa" style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.25rem" }}>
                Psoriatic arthritis (PsA) is a condition where the immune system mistakenly attacks the healthy tissues of skin and joints. The immune system is the body&apos;s natural defence against harmful germs and infections. In a healthy person, it carefully targets only outside threats.
              </p>
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.25rem" }}>
                In psoriasis, the immune system becomes overactive and mistakenly starts attacking the skin tissue, causing the skin to become red, thick, and scaly. In psoriatic arthritis, the overactive immune system starts attacking the joints. It is a form of arthritis that mainly affects people with psoriasis and can involve multiple joints, the spine, tendons, and nails all at once.
              </p>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep">
                Psoriatic arthritis affects approximately 8.7% of people with psoriasis in India (based on the RAPID-India group study, 2025). Still, it often goes undiagnosed. The reason: most patients see a dermatologist for the skin and a general doctor for the joints, so the two major symptoms never get connected. Due to different patterns and common symptoms, many patients reach a rheumatologist only after suffering for years.
              </p>
            </div>
            ...
            <div id="causes" style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "2rem" }}>
                The main cause of psoriatic arthritis is still unknown, but the immune system plays a central role. Certain factors — genes, stress, infection, vitamin D deficiency, and medication — trigger the immune system to attack healthy joints and skin tissue instead of protecting them. This causes persistent inflammation that can worsen without treatment.
              </p>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "2rem" }}>
                Vitamin D deficiency is very common in urban India and is linked to active inflammation of the disease. Arthritis that develops after chikungunya closely resembles the psoriatic joint pattern, which is one reason for misdiagnosis. Rheumatologist availability in smaller towns is limited, so many patients visit only after joint damage has already started.
              </p>
            ...
            <div id="symptoms" style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "2rem" }}>
                Psoriatic arthritis can affect the joints, skin, nails, spine, and tendons. Symptoms vary among people and usually worsen suddenly.
              </p>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "2rem" }}>
                Psoriasis patches are raised, red, silvery-scaled areas — most commonly on the scalp, elbows, knees, and lower back. Nail changes include pitting, crumbling, discolouration, and separation from the nail bed. These changes sometimes appear before joint pain, making them meaningful early signs that psoriatic arthritis may develop. It is best not to ignore these early signs, to prevent the disease from progressing.
              </p>

              <h3 style={H3Style}>Swelling and Pain</h3>
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.25rem" }}>
                Swelling can occur on the entire finger or toe, not just at one joint — this is called <strong className="font-semibold">dactylitis</strong>. Tendons are tight cords that attach the muscle of the finger to bone, running along the whole length of the finger. When these tendons become inflamed, the entire finger or toe swells, giving the characteristic &ldquo;sausage&rdquo; appearance that helps differentiate psoriatic arthritis from other types.
              </p>
              <p className="text-[17px] leading-[1.8] text-navy-deep">
                <strong className="font-semibold">Enthesitis</strong> is pain at the points where tendons attach to bone — most commonly in the heel, sole of the foot, elbow, and knee. Many patients first consult a doctor for heel pain without knowing they could have psoriatic arthritis.
              </p>
            </div>
            ...
            <div id="diagnosis" style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.25rem" }}>
                There is no single test to confirm psoriatic arthritis. Rheumatologists build a diagnosis based on clinical examination, blood tests, and imaging together. They examine the joints, skin, and nails, assess spine movement, and ask about family history. Joint and skin symptoms that occur together are the clearest diagnostic signal.
              </p>
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.25rem" }}>
                Doctors advise blood tests to measure inflammation (ESR and CRP), an X-ray to check bone changes, and an MRI for soft tissue and the spine. Ultrasound is used to check for enthesitis before it is visible on X-ray. The HLA-B27 gene test is done mainly when spine involvement is suspected. RF (rheumatoid factor) is usually negative in psoriatic arthritis, which helps separate it from rheumatoid arthritis.
              </p>
              <p className="text-[17px] leading-[1.8] text-navy-deep">
                The CASPAR criteria (Classification Criteria for Psoriatic Arthritis) is an internationally accepted diagnostic checklist that provides a structured basis for confirming the diagnosis.
              </p>
            </div>
            ...
            <div id="treatment" style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "2rem" }}>
                There is no cure for psoriatic arthritis. Treatment reduces inflammation, protects the joints, and manages skin symptoms. With the right treatment plan, most people can control the disease from progressing rapidly and live an active life.
              </p>

              <h3 style={H3Style}>Medications Overview</h3>
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "2rem" }}>
                NSAIDs only help reduce pain and stiffness — they cannot slow joint damage. DMARDs target the immune process causing the disease. Biologics are used when other treatments are not enough to control the disease. Medications should only be taken after a doctor&apos;s prescription.
              </p>

              <h3 style={H3Style}>Non-Medication Approaches and Skin Care</h3>
              <p className="text-[17px] leading-[1.8] text-navy-deep">
                Along with medication, physiotherapy helps maintain joint flexibility and muscle strength. Walking, swimming, and yoga support joint strength without much impact. Topical creams and medicated shampoos manage psoriasis patches along with medication. Keeping psoriasis plaques moisturised reduces cracking and infection risk.
              </p>
            </div>
            ...
            <div style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.5rem" }}>
                Both rheumatoid arthritis (RA) and psoriatic arthritis (PsA) cause joint pain, stiffness, and swelling — but they require different treatments, so it is important to tell them apart.
              </p>
            ...
            <div id="living" style={{ scrollMarginTop: "80px" }}>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep" style={{ marginBottom: "1.5rem" }}>
                Psoriatic arthritis is a long-term condition, but with small lifestyle and dietary changes you can live an active life:
              </p>
              ...
              <p className="text-[17px] leading-[1.8] text-navy-deep">
                Psoriasis is still wrongly believed to be contagious in many Indian communities, which pushes people toward isolation. Counselling and support from family and friends help significantly — reducing both the physical and emotional weight of managing the condition in the long term.
              </p>
            </div>

...
const riskFactors = [
  { factor: "Familial Genetic history", detail: "There is a higher chance of getting affected if Rheumatoid arthritis is present within close relatives (15% chance)." },
  { factor: "Sex", detail: "Women are affected 3 times more than men." },
  { factor: "Smoking", detail: "Smoking doubles the risk of Rheumatoid arthritis." },
  { factor: "Obesity", detail: "Excess fat increases the chances of Rheumatoid arthritis." },

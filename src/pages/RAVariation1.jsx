                  ...
                  <div className="guide-sidebar-scroll" style={{ backgroundColor: "#E8F4F8", overflowY: "auto", overflowX: "hidden", flex: "1 1 auto", minHeight: 0 }}>
                    ...
                    <nav className="flex flex-col">
                      {tocItems.map((s, i) => {
                        ...
                        return (
                          <button key={s.id} onClick={() => scrollToSection(s.id)} className="text-left flex items-center gap-3 pr-5 transition-colors" style={{ backgroundColor: isActive ? "#e2eef9" : "transparent", paddingLeft: "16px", paddingTop: "9px", paddingBottom: "9px", borderBottom: "1px solid rgba(15,97,110,0.08)", borderRadius: 0 }}>

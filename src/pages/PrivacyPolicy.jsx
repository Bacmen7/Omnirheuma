...
const sections = [
  {
    ...
    body: [
      "We are a specialist rheumatology practice based in Bengaluru, India, led by a DM-qualified rheumatologist. For the purposes of Indian data protection law, we are the <strong>Data Fiduciary</strong> in respect of the personal data described in this policy — meaning we decide why and how your data is processed.",
      {
        ul: [
  ...
  },
  {
    ...
    body: [
      "Information about your physical or mental health, medical records and history is treated as <strong>sensitive personal data or information</strong> under Indian law. We collect and use it only where you have given clear consent — for example by submitting an appointment form, describing your symptoms to us on WhatsApp, or attending a consultation — and only for the purpose of assessing, diagnosing and treating your condition and for the follow-up care that flows from it.",
    ...
    body: [
      ...
      { h: "What you should know before messaging us" },
      {
        ul: [
          ...
          "Anything clinically relevant that you send us on WhatsApp — symptoms, photographs of joints or rashes, lab reports — may be saved into your medical record so that it is available at your consultation.",

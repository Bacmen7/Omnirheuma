...
function BriefingFooter() {
  return (
    <footer className="pt-10 pb-6 px-6" style={{ backgroundColor: "#F5F5F5", fontFamily: "var(--font-base)", fontSize: "15px", lineHeight: "24px", fontWeight: 400, color: "#0F616E" }}>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="leading-relaxed" style={{ color: "#5E5E5E", fontSize: "13px", lineHeight: "19px", marginTop: "8px", marginBottom: "8px" }}>No. 42 &amp; 25, 1st Floor, 80 Feet Road, Dr. Shiva Ram Karanth Nagar, MCEHS Layout, Rachenahalli, Thanisandra, above Pepperfry Furniture, RK Hegde Nagar, Bengaluru – 560077</p>
